...
| `piton-viz.wasm`      | Go       | ~23 MB        | ~5.5 MB         | повний D2-візуалізатор          |

Runner вантажиться при першому кліку «Запустити»; viz — лазі-вантажиться лише коли користувач тисне «Блок-схема». Розщеплення зменшує bandwidth для більшості відвідувачів на 99%.
