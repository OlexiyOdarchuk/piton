...
Якщо ви хочете саме **вивчати мову**, а не читати огляд репозиторію, починайте з документації в `docs/`.

- Локально зібрати: `mdbook build docs`
- Локально відкрити: `mdbook serve docs`
