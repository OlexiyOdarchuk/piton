...
* `./piton -draw -target=main main.piton` - згенерувати блок-схему виключно для вказаної функції.
...
* [x] **🏗️ Генератор блок-схем** Реалізація нативного генератора MerMaid блок-схем для кожного рядка коду Piton.
